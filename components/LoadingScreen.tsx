...
const LoadingScreen = ({ children }: { children: React.ReactNode }) => {
    ...
    // Cek localStorage sebelum browser paint — returning users tidak melihat flash
    useLayoutEffect(() => {
    ...
    useEffect(() => {
        ...
        const onReady = () => {
            // Tunggu semua video di halaman siap diputar
            ...
            // Fallback: jika video tidak load dalam 4 detik, tetap tampil
