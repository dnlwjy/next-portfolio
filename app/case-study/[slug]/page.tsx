            ...
            <section className="sm">
                ...
                >
                    <ul className="flex gap-3 flex-wrap">
                        <Tag key="A" title="asdasdsad" />
                    </ul>
                    <h1>{placeholderContent.title}</h1>
                </MotionDiv>

                <MotionDiv variant="up" del={0.5} styles="grid sm:grid-cols-2 grid-cols-1 gap-4 w-full my-10">
                    <SubInfo title={placeholderContent.title} subtitle={placeholderContent.description} styles="pb-8 border-b border-(--divider)" />
                    <SubInfo title={placeholderContent.title} subtitle={placeholderContent.description} />
                    <SubInfo title={placeholderContent.title} subtitle={placeholderContent.description} />
                    <SubInfo title={placeholderContent.title} subtitle={placeholderContent.description} />
                </MotionDiv>
